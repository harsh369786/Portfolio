      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32">
          ...
          <div className="flex flex-col justify-between">
            <div className="space-y-12">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                {/* Responsive heading — scales down properly on mobile */}
                <h2 className="text-5xl md:text-7xl lg:text-9xl font-heading font-black mb-8 tracking-tighter leading-[0.9]">
                  Let's <br /><span className="text-accent underline decoration-accent/20 underline-offset-8">Scale</span> <br />Together.
                </h2>
                <p className="text-secondary text-lg md:text-2xl max-w-lg leading-relaxed mt-10">
              ...
              <div className="space-y-8 md:space-y-10">
                {/* Email — responsive text with word-break for mobile */}
                <a
                  href="mailto:shahharsh143.hs@gmail.com"
                  className="group flex items-center gap-4 md:gap-8 text-base md:text-3xl font-bold transition-all hover:text-accent interactive w-fit"
                >
                  <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-[#111111] border border-white/5 flex items-center justify-center text-secondary group-hover:text-accent group-hover:border-accent/30 transition-all duration-500 group-hover:-rotate-6 flex-shrink-0">
                    <Mail className="w-6 h-6 md:w-8 md:h-8" />
                  </div>
                  <span className="break-all">shahharsh143.hs@gmail.com</span>
                </a>

                <div className="flex flex-col gap-6 pl-2">
                  <div className="flex items-center gap-4 text-secondary font-medium tracking-wide text-sm md:text-base">
                    <MapPin className="w-5 h-5 text-accent flex-shrink-0" />
                    Mumbai, India · Available Worldwide
                  </div>
                  
                  <div className="flex items-center gap-4 py-3 px-4 md:px-6 rounded-2xl bg-accent/5 border border-accent/20 w-fit">
                    <span className="relative flex h-3 w-3">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-3 w-3 bg-green-500"></span>
                    </span>
                    <p className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-white/80">Available for Freelance Projects</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="mt-16 md:mt-20 flex gap-10">
          ...
          <motion.div
            ...
            className="bg-[#111111] p-8 md:p-16 rounded-[2rem] md:rounded-[3rem] border border-white/5 shadow-2xl overflow-hidden relative"
          >
        ...
        {/* Section Divider */}
        <div className="section-divider mt-40 md:mt-60" />

        {/* Minimal Footer */}
        <footer className="pt-16 md:pt-20 flex flex-col md:flex-row justify-between items-start md:items-end gap-12 pb-10">
          <div className="space-y-6">
            <h4 className="text-2xl md:text-3xl font-heading font-black tracking-tighter">HARSH SHAH.</h4>
